...
int inline MPU6050::query_register(int reg){
	return i2c_smbus_read_byte_data(f_dev,reg);
}

void inline MPU6050::set_register(int reg, int data){
	i2c_smbus_write_byte_data(f_dev, reg, data);
}
