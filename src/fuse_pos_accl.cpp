...
void fuse_position_acceleration::update(double measured_p, double measured_a, double dt) {
    ...
    estimated_p_variance = (1 - gain_p) * estimated_p_variance + 0.1; // + gain_p * observation_p_variance;
    estimated_v_variance = (1 - gain_v) * estimated_v_variance + 0.1; // + gain_v * measured_v_variance;
    estimated_a_variance = (1 - gain_a) * estimated_a_variance + 0.1; // + gain_a * observation_a_variance;
}